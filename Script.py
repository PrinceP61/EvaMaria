class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ 👋🙂 {},
ਮੇਰਾ ਨਾਮ ਹੈ(ᴍʏ ɴᴀᴍᴇ ɪs): <a href=https://t.me/{}>{}</a>,\nਮੈਂ ਤੁਹਾਨੂੰ ਪੰਜਾਬੀ ਫਿਲਮਾਂ ਪ੍ਰਦਾਨ ਕਰ ਸਕਦਾ ਹਾਂ, ਬੱਸ ਮੈਨੂੰ ਫਿਲਮ ਦਾ ਨਾਮ ਭੇਜੋ😍\n(I Cᴀɴ Pʀᴏᴠɪᴅᴇ Yᴏᴜ Pᴜɴᴊᴀʙɪ Mᴏᴠɪᴇs, Jᴜsᴛ Sᴇɴᴅ Mᴇ Mᴏᴠɪᴇ Nᴀᴍᴇ😍)</b>"""
    HELP_TXT = """<b>Hᴇʏ {} ✨
ਇੱਥੇ ਮੇਰੇ ਹੁਕਮਾਂ ਲਈ ਮਦਦ.
(Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.)</b>"""
    
    ABOUT_TXT = """<b>👑Oᴡɴᴇʀ​</b>:<a href=https://t.me/p4Princ3><b> 王子​</b></a>
<b>♯ Mʏ Nᴀᴍᴇ​</b>: {}
