        ...
        if int(clicked) == typed:
            ...
            try:
                if AUTH_CHANNEL and not await is_subscribed(client, query):
                    ...
                    f'<b>💾 sɪᴢᴇ:</b> {size}\n\n'
                    f'<b>❗️ਨੋਟ: ਕਾਪੀਰਾਈਟ ਮੁੱਦਿਆਂ ਦੇ ਕਾਰਨ ਫਾਈਲ ਨੂੰ 10 ਮਿੰਟਾਂ ਵਿੱਚ ਡਿਲੀਟ ਕਰ ਦਿੱਤਾ ਜਾਵੇਗਾ। ਡਿਲੀਟ ਹੋਣ ਤੌ ਪਹਿਲਾਂ ਫਾਈਲ ਨੂੰ SAVED MESSAGES ਵਿੱਚ ਜਾ ਆਪਣੇ ਦੋਸਤ ਨੂੰ ਭੇਜ ਲਵੋ।</b>\n'
                    f'<b>(❗️ɴᴏᴛᴇ: ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 10 ᴍɪɴᴜᴛᴇs. ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ ғᴏʀᴡᴀʀᴅ ᴛʜᴇ ғɪʟᴇ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs ᴏʀ ғʀɪᴇɴᴅ/ғᴀᴍɪʟʏ)</b>\n',
                    True,
